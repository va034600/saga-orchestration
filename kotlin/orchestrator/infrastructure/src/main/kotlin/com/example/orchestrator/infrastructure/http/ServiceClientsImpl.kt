package com.example.orchestrator.infrastructure.http
...
class ServiceClientsImpl(
    ...
    override fun createOrder(request: OrderRequest, traceId: String): OrderResponse {
    ...
    override fun completeOrder(orderId: String, traceId: String): OrderResponse {
    ...
    override fun authorizePayment(request: PaymentRequest, traceId: String): PaymentResponse {
    ...
    override fun capturePayment(orderId: String, traceId: String): PaymentResponse {
